...
echo "开始获取 ezn24/immich-geodata-zh_HK 仓库最新的 $geodata_name.zip 文件..."

# 获取最新 release 的 API URL
LATEST_RELEASE_API="https://api.github.com/repos/ezn24/immich-geodata-zh_HK/releases/latest"
